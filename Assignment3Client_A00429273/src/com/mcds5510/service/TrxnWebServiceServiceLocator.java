...
public class TrxnWebServiceServiceLocator extends org.apache.axis.client.Service
		implements com.mcds5510.service.TrxnWebServiceService {
	...
	public TrxnWebServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
			throws javax.xml.rpc.ServiceException {
		super(wsdlLoc, sName);
	}

	// Use to get a proxy class for TrxnWebService
	private java.lang.String TrxnWebService_address = "http://localhost:8080/Assignment3_A00429273/services/TrxnWebService";
	...
	public com.mcds5510.service.TrxnWebService getTrxnWebService(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			com.mcds5510.service.TrxnWebServiceSoapBindingStub _stub = new com.mcds5510.service.TrxnWebServiceSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (com.mcds5510.service.TrxnWebService.class.isAssignableFrom(serviceEndpointInterface)) {
				com.mcds5510.service.TrxnWebServiceSoapBindingStub _stub = new com.mcds5510.service.TrxnWebServiceSoapBindingStub(
						new java.net.URL(TrxnWebService_address), this);
				_stub.setPortName(getTrxnWebServiceWSDDServiceName());
				return _stub;
			}
