...
public class TestClient {
	...
	private static boolean checkSpecialCharacter(String varchar) {
		boolean isCorrect = true;
		if (varchar.contains(";") || varchar.contains(":") || varchar.contains("!") || varchar.contains("@")
				|| varchar.contains("#") || varchar.contains("$") || varchar.contains("%") || varchar.contains("^")
				|| varchar.contains("*") || varchar.contains("+") || varchar.contains("?") || varchar.contains("<")
				|| varchar.contains(">")) {
			isCorrect = false;
		}
	...
	private static boolean checkValidCardNumber(String cardNum) {
		...
		if (cardNum.length() == 16 && (cardNum.startsWith("51") || cardNum.startsWith("52") || cardNum.startsWith("53")
	...
	public static void main(String[] args) throws RemoteException {
		...
		proxy.setEndpoint("http://dev.cs.smu.ca:8049/Assignment3_A00429273/services/TrxnWebService");
