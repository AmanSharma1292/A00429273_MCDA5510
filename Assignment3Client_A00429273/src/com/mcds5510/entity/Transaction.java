...
public class Transaction implements java.io.Serializable {
	...
	public Transaction(java.lang.String cardNumber, java.lang.String cardType, java.lang.String createdBy,
			java.lang.String createdOn, java.lang.String expDate, java.lang.String id, java.lang.String nameOnCard,
			int quantity, double totalPrice, double unitPrice) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.cardNumber == null && other.getCardNumber() == null)
						|| (this.cardNumber != null && this.cardNumber.equals(other.getCardNumber())))
				&& ((this.cardType == null && other.getCardType() == null)
						|| (this.cardType != null && this.cardType.equals(other.getCardType())))
				...
				&& ((this.expDate == null && other.getExpDate() == null)
						|| (this.expDate != null && this.expDate.equals(other.getExpDate())))
				&& ((this.id == null && other.getId() == null) || (this.id != null && this.id.equals(other.getId())))
				&& ((this.nameOnCard == null && other.getNameOnCard() == null)
						|| (this.nameOnCard != null && this.nameOnCard.equals(other.getNameOnCard())))
				&& this.quantity == other.getQuantity() && this.totalPrice == other.getTotalPrice()
	...
	static {
		...
		elemField.setXmlName(new javax.xml.namespace.QName("http://entity.mcds5510.com", "cardType"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setNillable(true);
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
