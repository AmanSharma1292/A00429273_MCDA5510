...
public class MySqlAccess {
	...
	private void initLogger() {
		...
		try {
			...
			fh = new FileHandler("C:\\Users\\amans\\eclipse-workspace-jee\\Assignment3Server_A00429273\\logs\\db.log");
	...
	public void removeTrxns(String id, Connection connection_remove) {
		PreparedStatement statement = null;
		try {
			String deleteSql = "DELETE FROM transaction WHERE ID = " + id;
			System.out.println(deleteSql);
			statement = connection_remove.prepareStatement(deleteSql);
			System.out.println(deleteSql);
